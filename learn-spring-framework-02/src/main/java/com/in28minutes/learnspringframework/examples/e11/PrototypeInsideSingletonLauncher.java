...
//When we inject prototype bean instance inside Singleton class then Prototype loose its nature
//and only single instance of prototype is created every time
@Configuration
@ComponentScan
